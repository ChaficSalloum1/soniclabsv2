          ...
          <div className="grid-12">
            <div className="col-span-12 md:col-span-7 space-y-6">
              <div className={`transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
                ...
                <h1 className="hero-text text-balance mb-6">
                  ...
                  <span className="text-sonic-600">breakthrough</span>
                  <span className="text-foreground"> product faster</span>
                </h1>
                <p className="text-xl text-muted-foreground max-w-xl mb-8">
                  SonicLabs combines AI expertise with rapid development to transform your ideas into market-ready MVPs in record time.
                </p>
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                  <Button className="bg-sonic-600 hover:bg-sonic-700 text-white h-12 px-6 rounded-md">
                    Get Started Today
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
                  <Button variant="outline" className="h-12 px-6 border-sonic-200 text-foreground hover:bg-sonic-50">
                    View Our Work
                  </Button>
                </div>
              </div>
              
              <div className={`transition-all duration-700 delay-300 mt-12 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
                <div className="flex flex-wrap gap-4 items-center text-sm text-muted-foreground">
                  ...
                  <div className="flex gap-6 items-center flex-wrap">
                    ...
                    <div className="text-foreground font-semibold">Innovate AI</div>
                    <div className="text-foreground font-semibold">FutureLabs</div>
                    <div className="text-foreground font-semibold">DataSphere</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-12 md:col-span-5 flex justify-center items-start mt-12 md:mt-0">
              <div className={`relative transition-all duration-1000 delay-500 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
                <div className="relative w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] bg-gradient-to-tr from-sonic-600 to-sonic-400 rounded-full opacity-20 animate-pulse-light"></div>
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] bg-gradient-to-br from-sonic-600 to-sonic-400 rounded-full opacity-40"></div>
                <div className="absolute top-0 right-8 w-24 h-24 bg-white/90 backdrop-blur rounded-lg shadow-lg p-4 animate-float">
                  <Code2 className="h-full w-full text-sonic-600" />
                </div>
                <div className="absolute bottom-10 left-0 w-20 h-20 bg-white/90 backdrop-blur rounded-lg shadow-lg p-3 animate-float" style={{ animationDelay: '1s' }}>
                  <BarChart3 className="h-full w-full text-sonic-700" />
                </div>
                <div className="absolute top-1/4 left-10 w-16 h-16 bg-white/90 backdrop-blur rounded-lg shadow-lg p-3 animate-float" style={{ animationDelay: '2s' }}>
                  <Lightbulb className="h-full w-full text-sonic-500" />
                </div>
              </div>
            </div>
          </div>
